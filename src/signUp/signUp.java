   ...
   driver = new FirefoxDriver();
    ...
    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	   ...
	   public void test1 () throws ClassNotFoundException, SQLException, InterruptedException {
	     ...
	     new Select(driver.findElement(By.id("countryCode"))).selectByVisibleText("Ghana (+233)");
	     driver.findElement(By.id("mobileNumber")).clear();
	     driver.findElement(By.id("mobileNumber")).sendKeys("240762876");
	     ...
	     driver.manage().timeouts().pageLoadTimeout(300, TimeUnit.SECONDS);
		   ...
		   String query = " Select smsCode from acl.users where login='+233240762876' ";
