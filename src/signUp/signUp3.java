...
@BeforeClass
  public void beforeClass(){
	   ...
	   public void test2 () throws ClassNotFoundException, SQLException, InterruptedException {
	     ...
	     driver.findElement(By.id("ccNumber")).sendKeys("4111 1111 1111 1111");
	     driver.findElement(By.id("ccCVV")).clear();
	     driver.findElement(By.id("ccCVV")).sendKeys("123");
	     new Select(driver.findElement(By.id("ccExpYear"))).selectByVisibleText("2021");
	     ...
	     driver.findElement(By.id("billingAddress")).sendKeys("2312");
	     driver.findElement(By.id("billingAddress")).clear();
	     driver.findElement(By.id("billingAddress")).sendKeys("2312 Caminito Street");
	     ...
	     driver.findElement(By.id("billingZip")).sendKeys("92111");
